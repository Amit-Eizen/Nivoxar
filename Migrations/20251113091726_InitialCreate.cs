        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CanAddSubtasks = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SharedTasks_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SharedTasks_Tasks_TaskId",
                        column: x => x.TaskId,
            ...
            migrationBuilder.CreateTable(
                name: "SharedTaskParticipants",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SharedTaskId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Username = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SharedTaskParticipants", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SharedTaskParticipants_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SharedTaskParticipants_SharedTasks_SharedTaskId",
                        column: x => x.SharedTaskId,
                        principalTable: "SharedTasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SharedTaskParticipants_SharedTaskId",
                table: "SharedTaskParticipants",
                column: "SharedTaskId");

            migrationBuilder.CreateIndex(
                name: "IX_SharedTaskParticipants_UserId",
                table: "SharedTaskParticipants",
                column: "UserId");
